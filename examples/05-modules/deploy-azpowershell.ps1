# deploy-azpowershell.ps1 - Modules example (Azure PowerShell)
...
$DeploymentName = "main-deployment-20250717-134617"

Write-Host "Modules example using Azure PowerShell..." -ForegroundColor Green
