# deploy-azpowershell.ps1 - Outputs example (Azure PowerShell)
...
$DeploymentName = "storage-with-outputs-deployment-20250717-134617"

Write-Host "Outputs example using Azure PowerShell..." -ForegroundColor Green
...
try {
    $deployParams = @{
        ...
        TemplateFile = "storage-with-outputs.bicep"
        Name = $DeploymentName
        Verbose = $true
    }
        # Add parameters file
